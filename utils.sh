...
patch_apk() {
	...
	local cmjava -jar $rv_cli_jar patch $stock_input --purge -o $patched_apk -p $rv_patches_jar \
--keystore=ks.keystore --keystore-entry-password=5QcOfinpB10SUbld9zRv \
--keystore-password=5QcOfinpB10SUbld9zRv --signer=V --keystore-entry-alias=ks $patcher_args
